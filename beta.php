...
<p>Techniciens</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="flip-right" data-aos-delay="100">
                            ...
                            <div class="box">
                                ...
                                <h3>Ordinateur</h3>
                                <h4><sub>à partir de</sub>19,90<sup>&nbsp;€</sup><br><sub>la 1ère heure</sub></h4>
                                <ul>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="flip-right" data-aos-delay="100">
                            ...
                            <div class="box featured">
                                ...
                                <h4><sub>à partir de</sub>29,90<sup>&nbsp;€</sup></h4>
                                <ul>
                    ...
                    <div class="faq-list">
                        <ul>
                            ...
                            <li data-aos="fade-up" data-aos-delay="400">
                                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-4" class="collapsed"> Je suis mineur et je souhaite votre aide. Comment dois-je faire ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                <div id="faq-list-4" class="collapse" data-parent=".faq-list">
                                    <p>
                                        Si vous êtes mineur, discutez avec vos parents ou vos responsables légaux de l’opportunité d’utiliser nos services.<br>  Nous aurons besoin de l’accord de vos responsables afin d’établir votre dossier.                </p>
                                </div>
                            </li>
    ...
    <a href="https://dnslookup.fr/happytech63.fr"><img src="https://dnslookup.fr/images/OKDnsLookUp.png" alt="happytech63.fr certifié de qualité par DNSLookUp"></a>
